...
(function () {'use strict';
  for (var
    ...
    parse = isNodeJS ?
      ...
      (function () {
        return function (txt) {
          ...
          // :blink: *italic* **bold** -dim- ?hidden? !reverse! _underline_ ~strike~
          txt = replace(txt, 'blink');
          txt = replace(txt, 'boldedItalic');
    ...
    boldAndItalicsReplacer = function ($0, $1, $2, $3, $4, $5) {
      return $0 + '%c' + $2 + $3 + '%c' + $5;
    },
    ...
    transform = {
      ...
      boldedItalic: {
        re: /([^*]|\b|^)(\*{3})(?=[^*]\S)(.*?)(\S*(?:[^*]))(\*{3})([^*]|\b|$)/g,
        place: boldAndItalicsReplacer,
        start: 'font-weight:bold; font-style:italic;',
        end: 'font-weight:default; font-style:default;'
      },
      bold: {
        re: /([^*]|\b|^)(\*{2})(?=[^*]\S)(.*?)(\S*(?:[^*]))(\*{2})([^*]|\b|$)/g,
        place: boldAndItalicsReplacer,
